...
export const GameRound = () => {
  const { gameState, currentPlayer, mode, setMode, setGamestate } =
    useGameContext();
  ...
  const [visions, setVisions] = useState<
    Array<{ target: string; role: string }>
  >([]);
          ...
          <div className="night-actions">
            ...
            <div className="dead-player-message p-4 bg-red-100 border border-red-400 rounded">
              ...
              <p className="text-gray-600 mt-2">
                You can continue to watch the game unfold.
              </p>
            </div>
          </div>
        );
      ...
      if (role === "villager") {
        return (
          <div className="night-actions">
            <h3 className="text-xl font-semibold mb-4">Night Phase</h3>
            <p>
              You are a villager. Wait for others to complete their night
              actions.
            </p>
          </div>
        );
  ...
  return (
    <div className="game-round p-6">
      ...
      <div className="game-info mb-6">
        ...
        <p className="text-lg">
          Phase: {mode.charAt(0).toUpperCase() + mode.slice(1)}
        </p>
      ...
      {gameState.phase === GamePhase.Day && <ChatRoom />}
    </div>
  );
};
